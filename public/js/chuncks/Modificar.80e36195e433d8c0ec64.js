...
function SearchUsers(_ref) {
  ...
  var loading = open && options.length === 0; //Crear un SnackBar
  ...
  return (/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    , {
      ...
      ,
      getOptionSelect: function getOptionSelect(option, value) {
        return option.cedula === value;
      } //Texto a mostrar al seleccionar un resultado.
      ,
      ...
      ,
      onOpen: function onOpen() {// setOpen(true);
      } //Acción al cerrar.
      ,
