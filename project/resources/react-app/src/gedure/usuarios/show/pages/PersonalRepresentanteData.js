				...
				<Grid container spacing={2}>
					...
					<Grid item xs={12}>
						<RenderSelectFormHook
							...
							control={control}
							defaultValue={dataUser.personal_data.repre_nacionalidad || ''}
					...
					<Grid item xs={12}>
						<TextField
							...
							label='Cédula'
							size='small'
							defaultValue={dataUser.personal_data.repre_cedula || ''}
							disabled={loading}
							fullWidth
						/>
					</Grid>
					<Grid item xs={12}>
						<TextField
							...
							size='small'
							defaultValue={dataUser.personal_data.repre_nombre || ''}
							disabled={loading}
							fullWidth
						/>
					</Grid>
					<Grid item xs={12}>
						<TextField 
							...
							label='Teléfono'
							size='small'
							defaultValue={dataUser.personal_data.repre_telefono || ''}
							disabled={loading}
							fullWidth
							InputProps={{
					...
					<Grid item xs={12}>
						<TextField
							...
							size='small'
							defaultValue={dataUser.personal_data.repre_direccion || ''}
							disabled={loading}
							fullWidth
						/>
					</Grid>
					<Grid item xs={12}>
						<FormControl component="fieldset" disabled={loading}>
							...
							<RadioGroup 
								aria-label="sexo" 
								defaultValue={dataUser.personal_data.repre_sexo || 'Masculino'}
					...
					<Grid item xs={12}>
						<RenderSelectFormHook
							...
							control={control}
							defaultValue={dataUser.personal_data.repre_tipo_familiar || ''}
					...
					<Grid item xs={12}>
						<RenderSelectFormHook
							...
							control={control}
							defaultValue={dataUser.personal_data.repre_estado_civil || ''}
					...
					<Grid item xs={12}>
						<Controller
							...
							control={control}
							defaultValue={dataUser.personal_data.repre_nacimiento ? format(new Date(dataUser.personal_data.repre_nacimiento), 'yyyy/MM/dd') : ''}
							rules={{ 
								required: { value: true, message: '* Campo requerido' },
								valueAsDate: true,
							}}
					...
					<Grid item xs={12}>
						<TextField 
							...
							label='Correo'
							size='small'
							defaultValue={dataUser.personal_data.repre_email || ''}
							disabled={loading}
							fullWidth
						/>
					</Grid>
