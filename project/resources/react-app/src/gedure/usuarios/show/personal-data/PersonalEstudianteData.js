				...
				<Grid container spacing={2}>
					...
					<Grid item xs={12}>
						<FormControl component="fieldset" disabled={loading}>
							...
							<RadioGroup 
								aria-label="sexo" 
								defaultValue={dataUser.personal_data.estudi_sexo || 'Masculino'} 
					...
					<Grid item xs={12}>
						<RenderSelectFormHook
							...
							control={control}
							defaultValue={dataUser.personal_data.estudi_estado_civil || ''} 
					...
					<Grid item xs={12}>
						<RenderSelectFormHook
							...
							control={control}
							defaultValue={dataUser.personal_data.estudi_lateralidad || ''} 
					...
					<Grid item xs={12}>
						<RenderSelectFormHook
							...
							control={control}
							defaultValue={dataUser.personal_data.estudi_nacionalidad || ''} 
					...
					<Grid item xs={12}>
						<Controller
							...
							control={control}
							defaultValue={dataUser.personal_data.estudi_nacimiento ? format(new Date(dataUser.personal_data.estudi_nacimiento), 'yyyy/MM/dd') : ''}
							rules={{ 
					...
					{watch('personalData.estudi_nacionalidad', '') === 'V' && (
						<Grid item xs={12}>
							<Controller 
								...
								defaultValue={dataUser.personal_data.estudi_nacimiento_estado || ''}
								rules={{
									required: { value: true, message: '* Campo requerido' },
								}}
							/>
					...
					<Grid item xs={12}>
						<TextField 
							...
							defaultValue={dataUser.personal_data.estudi_nacimiento_lugar || ''}
