...
$(document).ready(function() {
  $("span.cookie_link").on("click", function() {
    ...
    "<p style='text-align: justify; margin: 0px 15px'>Usted puede eliminar y bloquear todas las cookies de este sitio, pero parte del sitio puede llegar a no funcionar correctamente.</p>";
